...
var ProductFormComponent = /** @class */ (function () {
    function ProductFormComponent(aps, router, activeRoute, toaster) {
        ...
        this.copyingId = null; // store the product id that the new product will copy from
    ...
    ProductFormComponent.prototype.ngOnInit = function () {
        ...
        this.activeRoute.queryParamMap.subscribe(function (p) {
            var editId = Number(p.get('editId'));
            if (editId) {
            ...
            _this.copyingId = Number(p.get('copyId'));
            if (_this.copyingId) {
                _this._formJob = src_app_common_GlobalConstants__WEBPACK_IMPORTED_MODULE_8__["FormJob"].Copy;
                _this.getProduct(_this.copyingId, src_app_common_GlobalConstants__WEBPACK_IMPORTED_MODULE_8__["FormJob"].Copy);
            }
        });
    ...
    ProductFormComponent.prototype.updateProduct = function () {
        ...
        this.aps.UpdateProduct(this._Product.Id, this._Product).subscribe(function (ProductId) {
            ...
            if (_this.MainImage || // the cases when whe have to call upload method ..
                _this.GalleryImgs.length > 0 ||
                _this.DescImgs.length > 0 ||
                _this.GalleryImgsDrop.length > 0 ||
                _this.DescImgsDrop.length > 0) {
                _this.uploadProductImages(ProductId);
            }
        }, function (error) {
            if (error instanceof src_app_common_errors_http_errors__WEBPACK_IMPORTED_MODULE_5__["BadInput"]) {
    ...
    ProductFormComponent.prototype.asMainImageServer = function (img) {
        var _this = this;
        this.aps.ReplaceMainImg(this._Product.Id, img).subscribe(function () {
    ...
    ProductFormComponent.prototype.kill = function () {
        this._Product = new _models_adminProduct__WEBPACK_IMPORTED_MODULE_3__["AdminProduct"]();
    };
