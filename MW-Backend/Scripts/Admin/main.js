...
module.exports = "<form [formGroup]=\"form\" (ngSubmit)=\"addVariant()\" autocomplete=\"off\" class=\"variantsContainer\">\n  <div class=\"variantsInputs\">\n    <mat-form-field>\n      <input matInput formControlName=\"Variant\" placeholder=\"Variant\" type=\"text\" />\n    </mat-form-field>\n    <mat-form-field>\n      <input matInput formControlName=\"Value\" placeholder=\"Value\" type=\"text\" />\n    </mat-form-field>\n    <mat-form-field>\n      <input matInput formControlName=\"Price\" placeholder=\"Price\" type=\"number\" />\n    </mat-form-field>\n    <div (click)=\"varImage.click()\" class=\"varImage\">\n      <input formControlName=\"Image\" #varImage placeholder=\"Image\" type=\"file\"\n        (change)=\"previewMainImg($event.target.files)\" style=\"display: none\" />\n      <img *ngIf=\"imgPath; else noImage\" [src]=\"imgPath\" class=\"mainimage\" />\n      <ng-template #noImage>\n        <svg _ngcontent-c3=\"\" xml:space=\"preserve\" class=\"svgplusimage\" enable-background=\"new 0 0 1000 1000\"\n          version=\"1.1\" viewBox=\"0 0 1000 1000\" x=\"0px\" y=\"0px\">\n          <path _ngcontent-c3=\"\"\n            d=\"M383.6,313.6c0-38.7-31.4-70-70.1-70c-38.7,0-70,31.4-70,70c0,38.7,31.4,70.1,70,70.1C352.3,383.6,383.6,352.3,383.6,313.6L383.6,313.6z\">\n          </path>\n          <path _ngcontent-c3=\"\" d=\"M383.6,313.6\"></path>\n          <path _ngcontent-c3=\"\"\n            d=\"M616.5,671.3h57.9v-57.9c0-42.6,25.6-79.3,62.1-95.9l-9.7-33.2V482h0.1l-63.3-191.4L442.4,576l-59.3-100.4L148,712.9h346.3h38.9C552.5,687.8,582.5,671.3,616.5,671.3z\">\n          </path>\n          <path _ngcontent-c3=\"\"\n            d=\"M990,166.8C990,80.6,919.4,10,833.2,10H166.8C80.6,10,10,80.6,10,166.8v666.4C10,919.4,80.6,990,166.8,990h470.4v0c0.1,0,0.1,0,0.2,0c16.2,0,29.4-13.2,29.4-29.4c0-16.2-13.2-29.4-29.4-29.4c-0.1,0-0.1,0-0.2,0v0H166.8c-54.1,0-98-43.9-98-98V166.8c0-54.1,43.9-98,98-98h666.4c54.1,0,98,43.9,98,98v467.5c0,0.4-0.2,0.6-0.2,0.9c0,16.2,13.2,29.4,29.4,29.4c16.2,0,29.4-13.2,29.4-29.4c0-0.1-0.1-0.2-0.1-0.4h0.3V166.8z\">\n          </path>\n          <path _ngcontent-c3=\"\"\n            d=\"M959.5,747.5H809.6V597.6c0-16.2-13.2-29.4-29.4-29.4c-16.2,0-29.4,13.2-29.4,29.4v149.9H600.9c-16.2,0-29.4,13.2-29.4,29.4c0,16.2,13.2,29.4,29.4,29.4h149.9v149.9c0,16.2,13.2,29.4,29.4,29.4c16.2,0,29.4-13.2,29.4-29.4V806.3h149.9c16.2,0,29.4-13.2,29.4-29.4C988.9,760.6,975.7,747.5,959.5,747.5z\">\n          </path>\n        </svg>\n      </ng-template>\n    </div>\n\n    <button type=\"submit\" class=\"loginBtn\">Add Variant</button>\n  </div>\n  <div class=\"variantsList\"></div>\n</form>\n\n<!-- <data-viewer [data]=\"form.value\"></data-viewer> -->\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var src_app_shared_validators_product_validators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/validators/product.validators */ "./src/app/shared/validators/product.validators.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var src_app_shared_GlobalConstants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/GlobalConstants */ "./src/app/shared/GlobalConstants.ts");
/* harmony import */ var src_app_services_product_variant_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/product-variant.service */ "./src/app/services/product-variant.service.ts");
...
var VariantComponent = /** @class */ (function () {
    function VariantComponent(data, productVariants) {
        this.data = data;
        this.productVariants = productVariants;
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            Variant: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, src_app_shared_validators_product_validators__WEBPACK_IMPORTED_MODULE_3__["ProductValidators"].cannotContainSpace]),
            Value: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, src_app_shared_validators_product_validators__WEBPACK_IMPORTED_MODULE_3__["ProductValidators"].cannotContainSpace]),
        ...
        this.common_variants = [
            {
                "label": "color",
                "options": src_app_shared_GlobalConstants__WEBPACK_IMPORTED_MODULE_5__["COMMUN_COLORS"]
            },
            {
                "label": "size",
    ...
    Object.defineProperty(VariantComponent.prototype, "Variant", {
        get: function () {
            return this.form.get('Variant').value;
        },
        set: function (value) {
    ...
    VariantComponent.prototype.ngOnInit = function () {
        this.productVariants.GetProductVariants(this.data.id).subscribe(function (model) {
            console.log(model);
        });
    };
    VariantComponent.prototype.addVariant = function () {
    };
    VariantComponent.prototype.previewMainImg = function (files) {
        var _this = this;
        if (files[0]) {
            var reader = new FileReader();
            reader.onload = function (e) {
    ...
    VariantComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Object, src_app_services_product_variant_service__WEBPACK_IMPORTED_MODULE_6__["ProductVariantService"]])
    ], VariantComponent);
...
var ProductVariantService = /** @class */ (function () {
    function ProductVariantService(http) {
        this.http = http;
        this.END_POINT = 'api/ProductVariant/';
    }
