...
/* harmony import */ var _guards_admin_auth_guard__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./guards/admin-auth.guard */ "./src/app/guards/admin-auth.guard.ts");
...
/* harmony import */ var _guards_not_logged_guard__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./guards/not-logged.guard */ "./src/app/guards/not-logged.guard.ts");
...
var routes = [
    { path: "admin/login", component: _login_login_component__WEBPACK_IMPORTED_MODULE_18__["LoginComponent"], canActivate: [_guards_not_logged_guard__WEBPACK_IMPORTED_MODULE_19__["NotLoggedGuard"]] },
    ...
    {
        path: "",
        component: _layout_layout_component__WEBPACK_IMPORTED_MODULE_17__["LayoutComponent"], canActivate: [_guards_admin_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AdminAuthGuard"]],
        children: [
            { path: "", component: _product_product_form_product_form_component__WEBPACK_IMPORTED_MODULE_5__["ProductFormComponent"] },
...
/* harmony import */ var ngx_scrollbar__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ngx-scrollbar */ "./node_modules/ngx-scrollbar/fesm5/ngx-scrollbar.js");
/* harmony import */ var _shared_dialogs_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./shared/dialogs/confirm-dialog/confirm-dialog.component */ "./src/app/shared/dialogs/confirm-dialog/confirm-dialog.component.ts");
/* harmony import */ var _services_admin_upload_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./services/admin-upload.service */ "./src/app/services/admin-upload.service.ts");
...
/* harmony import */ var _services_admin_auth_service__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./services/admin-auth.service */ "./src/app/services/admin-auth.service.ts");
/* harmony import */ var _shared_auth_interceptor__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./shared/auth-interceptor */ "./src/app/shared/auth-interceptor.ts");
...
/* harmony import */ var _shared_pipes_iterate_pipe__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./shared/pipes/iterate.pipe */ "./src/app/shared/pipes/iterate.pipe.ts");
/* harmony import */ var _shared_filter_components_table_filter_table_filter_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./shared/filter-components/table-filter/table-filter.component */ "./src/app/shared/filter-components/table-filter/table-filter.component.ts");
/* harmony import */ var _shared_dialogs_infos_infos_dialog_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./shared/dialogs/infos/infos-dialog.component */ "./src/app/shared/dialogs/infos/infos-dialog.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _shared_dialogs_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_30__["ConfirmDialogComponent"],
                ...
                _shared_pipes_iterate_pipe__WEBPACK_IMPORTED_MODULE_37__["IteratePipe"],
                _shared_filter_components_table_filter_table_filter_component__WEBPACK_IMPORTED_MODULE_38__["TableFilterComponent"],
                _shared_dialogs_infos_infos_dialog_component__WEBPACK_IMPORTED_MODULE_39__["InfosDialogComponent"],
            ],
            imports: [
                ...
                ngx_scrollbar__WEBPACK_IMPORTED_MODULE_29__["NgScrollbarModule"],
                ...
                _angular_material__WEBPACK_IMPORTED_MODULE_28__["MatRadioModule"],
            ...
            providers: [
                _services_admin_auth_service__WEBPACK_IMPORTED_MODULE_34__["AdminAuthService"],
                _services_admin_product_service__WEBPACK_IMPORTED_MODULE_14__["AdminProductService"],
                _services_admin_upload_service__WEBPACK_IMPORTED_MODULE_31__["AdminUploadService"],
                // { provide: ErrorHandler, useClass: AppErrorHandler },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _shared_auth_interceptor__WEBPACK_IMPORTED_MODULE_35__["AuthInterceptor"], multi: true }
            ],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]],
            entryComponents: [_shared_dialogs_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_30__["ConfirmDialogComponent"], _shared_dialogs_infos_infos_dialog_component__WEBPACK_IMPORTED_MODULE_39__["InfosDialogComponent"]]
        })
    ], AppModule);
    return AppModule;
}());
...
var ProductHistoryComponent = /** @class */ (function () {
    ...
    ProductHistoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_admin_product_service__WEBPACK_IMPORTED_MODULE_2__["AdminProductService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
...
/* harmony import */ var src_app_shared_QueryObject__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/QueryObject */ "./src/app/shared/QueryObject.ts");
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(productService, router, toaster) {
        this.productService = productService;
        this.router = router;
        this.toaster = toaster;
        this.columns = [
        ...
        this.queryObj = new src_app_shared_QueryObject__WEBPACK_IMPORTED_MODULE_9__["QueryObject"]();
    }
    ...
    ProductListComponent.prototype.deleteProduct = function (id) {
        var _this = this;
        this.productService.raiseConfirmDialog().subscribe(function (res) {
            if (res) {
                _this.productService.deleteProduct(id).subscribe(function () { return _this.populateProducts(); }, function (err) {
    ...
    ProductListComponent.prototype.deleteRange = function (products) {
        var _this = this;
        this.productService.raiseConfirmDialog().subscribe(function (res) {
            if (res) {
                var ids_1 = [];
                products.forEach(function (x) { return ids_1.push(x.Id); });
                _this.productService.deleteRange(ids_1).subscribe(function () {
...
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var _shared_dialogs_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shared/dialogs/confirm-dialog/confirm-dialog.component */ "./src/app/shared/dialogs/confirm-dialog/confirm-dialog.component.ts");
/* harmony import */ var _shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/errors/http-errors */ "./src/app/shared/errors/http-errors.ts");
...
var AdminProductService = /** @class */ (function () {
    ...
    AdminProductService.prototype.PostProduct = function (form) {
        return this.http.post(this.END_POINT, form).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__["handleExpectedErrors"]));
    };
    AdminProductService.prototype.UpdateProduct = function (id, p) {
        return this.http.put('/api/UpdateProduct/' + id.toString(), p).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__["handleExpectedErrors"]));
    };
    ...
    AdminProductService.prototype.getProduct = function (id) {
        return this.http.get(this.END_POINT + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__["handleExpectedErrors"]));
    };
    AdminProductService.prototype.deleteProduct = function (id) {
        return this.http.delete(this.END_POINT + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__["handleExpectedErrors"]));
    };
    AdminProductService.prototype.deleteRange = function (Ids) {
        return this.http.post('/api/DeleteRange/', Ids).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__["handleExpectedErrors"]));
    };
    // Shared Functions
    ...
    AdminProductService.prototype.raiseConfirmDialog = function () {
        return this.dialog.open(_shared_dialogs_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmDialogComponent"], {
...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.getCategoriesLocally = function () {
        var categories = localStorage.getItem("MWCategories");
        return JSON.parse(categories);
    };
    CategoryService.prototype.getCategoriesFromServer = function () {
        var _this = this;
        return this.http.get('api/Categories').subscribe(function (cats) {
            localStorage.setItem("MWCategories", JSON.stringify(cats));
            _this._categories = cats;
        }, function () { return _this.toaster.error("Could Not Get New Categories .."); });
    };
...
/*!*******************************************!*\
  !*** ./src/app/shared/GlobalConstants.ts ***!
  \*******************************************/
/*! exports provided: FormJob, ADMIN_ROLE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _QueryObject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../QueryObject */ "./src/app/shared/QueryObject.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
...
var TableFilterComponent = /** @class */ (function () {
    function TableFilterComponent(categoryService, dialog) {
        this.categoryService = categoryService;
        this.dialog = dialog;
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _QueryObject__WEBPACK_IMPORTED_MODULE_3__["QueryObject"])
    ...
    TableFilterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_category_service__WEBPACK_IMPORTED_MODULE_2__["CategoryService"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"]])
