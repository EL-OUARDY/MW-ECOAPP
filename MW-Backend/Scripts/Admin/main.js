...
var AdminProductService = /** @class */ (function () {
    ...
    AdminProductService.prototype.toQueryString = function (obj) {
        ...
        if (obj.Search) {
            var key = obj.Search.charAt(0);
            var key2 = obj.Search.substr(0, 1);
            console.log(key);
            console.log(key2);
            switch (key) {
                case '#':
...
var TableFilterComponent = /** @class */ (function () {
    function TableFilterComponent(categoryService) {
        this.categoryService = categoryService;
