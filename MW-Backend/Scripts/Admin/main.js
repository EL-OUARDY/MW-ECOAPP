...
module.exports = "<input type=\"file\"  (change)=\"imageChanged($event.target.files)\">\r\n<button (click)=\"f()\" >ClickMe!</button>"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.f = function () {
        this.fd.append("Variant", "Color");
        this.http.post("api/demo", this.fd).subscribe(function (response) { return console.log(response); });
    };
    DashboardComponent.prototype.imageChanged = function (files) {
