...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(snackbar) {
        ...
        this.date = new Date();
        this.res = luxon__WEBPACK_IMPORTED_MODULE_3__["DateTime"].fromISO("2019-12-07T19:06:41+01:00").toRelative();
    }
...
var TableFilterComponent = /** @class */ (function () {
    ...
    TableFilterComponent.prototype.minDateInputChange = function () {
        ...
        if (luxon__WEBPACK_IMPORTED_MODULE_8__["DateTime"].fromJSDate(this.minDate).valueOf() > luxon__WEBPACK_IMPORTED_MODULE_8__["DateTime"].fromJSDate(this.maxDate).valueOf())
