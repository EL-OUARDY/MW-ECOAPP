...
var ProductListComponent = /** @class */ (function () {
    ...
    ProductListComponent.prototype.deleteProduct = function (id, permanently) {
        ...
        this.productService.raiseConfirmDialog(message).subscribe(function (res) {
            if (res) {
...
var AdminProductService = /** @class */ (function () {
    ...
    AdminProductService.prototype.deleteProduct = function (id, permanently) {
        if (permanently === void 0) { permanently = false; }
        return this.http.delete(this.END_POINT + id + "/" + permanently).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__["handleExpectedErrors"]));
    };
    AdminProductService.prototype.restoreProducts = function (ids) {
        return this.http.post('api/RestoreProduct', ids).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__["handleExpectedErrors"]));
    };
    AdminProductService.prototype.deleteRange = function (Ids, permanently) {
        if (permanently === void 0) { permanently = false; }
        return this.http.post("/api/DeleteRange/" + permanently, Ids).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_shared_errors_http_errors__WEBPACK_IMPORTED_MODULE_6__["handleExpectedErrors"]));
    };
    ...
    AdminProductService.prototype.raiseConfirmDialog = function (message) {
