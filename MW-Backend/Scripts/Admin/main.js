...
var routes = [
    { path: 'admin', component: _product_product_list_product_list_component__WEBPACK_IMPORTED_MODULE_9__["ProductListComponent"], canActivate: [_guards_admin_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AdminGuard"]] },
...
var AdminProduct = /** @class */ (function () {
    ...
    Object.defineProperty(AdminProduct.prototype, "Qte", {
        get: function () {
            if (!this.OnSale) {
                return 0;
            }
...
var ProductHistoryComponent = /** @class */ (function () {
    function ProductHistoryComponent(aps, toaster) {
        this.aps = aps;
        this.toaster = toaster;
