...
var routes = [
    ...
    { path: 'admin/edit-product/:id', component: _product_product_form_product_form_component__WEBPACK_IMPORTED_MODULE_6__["ProductFormComponent"], canActivate: [_guards_admin_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AdminGuard"]] },
...
var ProductFormComponent = /** @class */ (function () {
    function ProductFormComponent(aps, router, activeRoute, toaster) {
        var _this = this;
        this.aps = aps;
        this.router = router;
    ...
    ProductFormComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.activeRoute.paramMap.subscribe(function (p) {
    ...
    ProductFormComponent.prototype.updateProduct = function () {
        ...
        this.aps.UpdateProduct(this._Product.Id, this._Product).subscribe(function (ProductId) {
        ...
        var _loop_1 = function (i) {
            ...
            if (files[i] && !exist) {
                ...
                reader.onload = function (e) {
                    ...
                    if (_this.GalleryImgs.length < _this._maxG) {
    ...
    ProductFormComponent.prototype.addGalleryImagesServer = function (files) {
        var _this = this;
        var _loop_2 = function (i) {
            var exist = (this_2.GalleryImgs.find(function (x) { return x.name === files[i].name; })) ? true : false;
            if (files[i] && !exist) {
                var reader = new FileReader();
                reader.onload = function (e) {
                    var item = {
                    ...
                    if ((_this.GalleryImgs.length + _this._Product.galleryImgs.length) < _this._maxG) {
                        _this.GalleryImgs.push(item);
                    }
                };
                reader.readAsDataURL(files[i]);
    ...
    ProductFormComponent.prototype.addDescImages = function (files) {
        ...
        var _loop_3 = function (i) {
            var exist = (this_3.DescImgs.find(function (x) { return x.name === files[i].name; })) ? true : false;
            if (files[i] && !exist) {
                var reader = new FileReader();
                reader.onload = function (e) {
                    var item = {
                    ...
                    if (_this.DescImgs.length < _this._maxD) {
    ...
    ProductFormComponent.prototype.addDescImagesServer = function (files) {
        var _this = this;
        var _loop_4 = function (i) {
            var exist = (this_4.DescImgs.find(function (x) { return x.name === files[i].name; })) ? true : false;
            if (files[i] && !exist) {
                var reader = new FileReader();
                reader.onload = function (e) {
                    var item = {
                    ...
                    if ((_this.DescImgs.length + _this._Product.descImgs.length) < _this._maxD) {
                        _this.DescImgs.push(item);
                    }
                };
                reader.readAsDataURL(files[i]);
    ...
    ProductFormComponent.prototype.asMainImageServer = function (img) {
        var _this = this;
        this.aps.ReplaceMainImg(this._Product.Id, img).subscribe(function (data) {
            console.log(data);
    ...
    ProductFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_admin_product_service__WEBPACK_IMPORTED_MODULE_2__["AdminProductService"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"]])
...
var AdminProductService = /** @class */ (function () {
    ...
    AdminProductService.prototype.PostProduct = function (form) {
        return this.http.post('api/AdminProducts', form, { headers: this.noAuth }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(src_app_common_errors_http_errors__WEBPACK_IMPORTED_MODULE_4__["handleExpectedErrors"]));
    };
    ...
    AdminProductService.prototype.UploadImages = function (form) {
        return this.http.post('api/AdminProducts/upload-images', form, { headers: this.noAuth }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(src_app_common_errors_http_errors__WEBPACK_IMPORTED_MODULE_4__["handleExpectedErrors"]));
    };
    ...
    AdminProductService.prototype.getProduct = function (id) {
        return this.http.get('api/AdminProducts/' + id, { headers: this.noAuth }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(src_app_common_errors_http_errors__WEBPACK_IMPORTED_MODULE_4__["handleExpectedErrors"]));
    };
    AdminProductService.prototype.deleteProduct = function (id) {
        return this.http.delete('api/AdminProducts/' + id, { headers: this.noAuth }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(src_app_common_errors_http_errors__WEBPACK_IMPORTED_MODULE_4__["handleExpectedErrors"]));
    };
    AdminProductService.prototype.ReplaceMainImg = function (id, img) {
        var data = { id: id, filename: img };
        return this.http.post('api/ReplaceMainImg', data, { headers: this.noAuth }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(src_app_common_errors_http_errors__WEBPACK_IMPORTED_MODULE_4__["handleExpectedErrors"]));
    };
    // Shared Functions
