...
var routes = [
    ...
    { path: '**', component: _home_home_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"] } // Redirect to a 404
];
...
module.exports = "<p class=\"formData alert alert-success\">\n  {{ product.SubCategory.Name | json }}\n</p>\n"
